...
// PERSISTENCE (Specific to Secret Operations App)
let lifetimeScore = parseInt(localStorage.getItem('secretOperationsScore')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedSecretOperationsLessons')) || [];
if(ptsVal) ptsVal.innerText = lifetimeScore;

let wordBucket = []; let currentQ = 0; let attempts = 0; let totalScore = 0; let firstCard = null;

// STATIONS (Matching the Colab Audio Output exactly)
const stations = [
    {file:"01_Ajax.mp3", title:"Operation Ajax"},
    {file:"02_Anthropoid.mp3", title:"Operation Anthropoid"},
    {file:"03_Argo.mp3", title:"Operation Argo"},
    {file:"04_BayOfPigs.mp3", title:"Bay of Pigs Invasion"},
    {file:"05_Brothers.mp3", title:"Operation Brothers"},
    {file:"06_CarlosTheJackal.mp3", title:"Capture of Carlos the Jackal"},
    {file:"07_Diamond.mp3", title:"Operation Diamond"},
    {file:"08_EagleClaw.mp3", title:"Operation Eagle Claw"},
    {file:"09_Entebbe.mp3", title:"Operation Entebbe"},
    {file:"10_Finale.mp3", title:"Operation Finale"},
    {file:"11_Gunnerside.mp3", title:"Operation Gunnerside"},
    {file:"12_Isotope.mp3", title:"Operation Isotope"},
    {file:"13_IvyBells.mp3", title:"Operation Ivy Bells"},
    {file:"14_Jaque.mp3", title:"Operation Jaque"},
    {file:"15_NeptuneSpear.mp3", title:"Operation Neptune Spear"},
    {file:"16_Nimrod.mp3", title:"Operation Nimrod"},
    {file:"17_Oak.mp3", title:"Operation Oak"},
    {file:"18_PuebloIncident.mp3", title:"Pueblo Incident"},
    {file:"19_RainbowWarrior.mp3", title:"Operation Rainbow Warrior"},
    {file:"20_Valkyrie.mp3", title:"Operation Valkyrie"},
    {file:"21_WrathOfGod.mp3", title:"Operation Wrath of God"}
];
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('secretOperationsScore', lifetimeScore);
    const fn = decodeURIComponent(audio.src.split('/').pop());
    if(!completedLessons.includes(fn)) {
        completedLessons.push(fn); localStorage.setItem('completedSecretOperationsLessons', JSON.stringify(completedLessons));
    }
